...
export default function TrueMotion() {
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center pt-5">
      ...
      <div
        ...
        className={`relative w-full h-full transition-all duration-300 ease-in-out 
          ...
          `}
      >
        <div className="w-full h-full pb-24 flex flex-col gap-5">
    ...
    {!showExplanation ? (
        ...
        <AnswerBoxBottom isCorrect={isCorrect} answer={current.explanation} onClick={() => handleNext()}/>
    )}
...
function AnswerBoxBottom({isCorrect, answer, onClick}){
    ...
    <div className={`absolute bottom-0 left-0 right-0 z-10 flex justify-center`}>
        ...
        drop-shadow-[0px_-10px_10px_rgba(0,0,0,0.15)]">
            ...
            <p className="text-base mb-4"><span className="font-bold">Правильный ответ:</span> {answer}</p>
            <button
            onClick={onClick}
